...
mjd1 = lc_3650['time'].values
print(type(mjd1), len(mjd1))
flux1 =  (lc_3650['normalised_flux [arbitary unit]'].values)
err1 = (lc_3650['error'].values)
mjd2 = lc_4640['time'].values
flux2 =  (lc_4640['normalised_flux [arbitary unit]'].values)
err2 = (lc_4640['error'].values)
